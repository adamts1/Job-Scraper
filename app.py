...
area_input = "כל האיזורים"


def start():
    # print(type(str(GlobalVar.KEY_WORD)))
    # print(type(str(GlobalVar.KEY_WORD)))
    # print(type(GlobalVar.CATEGORY))
    # print(type(GlobalVar.AREA))
    # print(GlobalVar.AREA)
...
if __name__ == '__main__':
    ...
    category_entry = ttk.Combobox(root, width=14,
                              values=["כל הקטגוריות", "אבטחת מידע", "אדמיניסטרציה", "אופנה", "אינטרנט", "ביטוח",
    ...
    area_entry = ttk.Combobox(root, width=15,
                                  values=["כל האיזורים", "מרכז", "תל אביב", "רמת גן / גבעתיים", "חולון / בת ים",
                                          ...
                                          "עפולה / נצרת", "יוקנעם / רמת ישי"], textvariable=GlobalVar.AREA).pack(
        side="left")

    greet_button = ttk.Button(root, text="Search", command=start).pack(side="bottom", fill="both", expand=True,
                                                                       padx=(10))
